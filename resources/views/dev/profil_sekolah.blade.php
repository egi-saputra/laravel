    ...
    <div class="flex flex-col min-h-screen md:flex-row">
        <aside class="sticky z-10 w-full top-16 md:static md:w-auto md:ml-6 md:mt-6 md:h-screen md:top-0">
            ...
            <main class="flex-1 p-4 space-y-6 overflow-x-auto md:p-6">
                ...
                <form action="{{ route('dev.profil_sekolah.storeOrUpdate') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    @csrf
                    ...
                    <div class="flex flex-col items-center mb-4">
                        <div class="w-32 h-32 mb-2 overflow-hidden rounded">
                            @if($profil && $profil->file_path)
                                <img src="{{ asset('storage/' . $profil->file_path) }}" class="object-contain w-full h-full">
                            @else
