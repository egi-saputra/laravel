            ...
            <div class="p-4 bg-white rounded shadow">
                ...
                <form method="GET" class="flex flex-wrap w-full gap-2 mb-4">
                    ...
                    <select name="role" class="w-48 px-3 py-2 border rounded">
                        ...
                        @foreach(['developer','admin','guru','staff','siswa','user'] as $role)
                                ...
                                <tr>
                                    ...
                                    <td class="px-4 py-2 border">
                                        <div class="flex justify-center gap-2">
                                            <button
                                                onclick="openModal({{ $user->id }}, '{{ $user->role }}', '{{ route('dev.users.update', $user->id) }}')"
                                                class="px-3 py-1 text-white bg-blue-600 rounded hover:bg-blue-700">
                                                <i class="bi bi-pencil-square"></i>
                                            </button>
                                            <form action="{{ route('dev.users.destroy', $user->id) }}" method="POST" class="delete-form">
                                                @csrf
                                                @method('DELETE')
