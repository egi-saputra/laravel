<div class="bg-white">
    ...
    <p class="mb-4">
        ...
        <span class="font-semibold">
            (Jumlah Kehadiran × Uang Transport) +
        ...
        <table class="min-w-full border border-gray-300" id="rekapGuruTable">
            <thead class="bg-gray-100">
                <tr class="text-center">
                    ...
                    <th class="px-4 py-2 border whitespace-nowrap">Jumlah Kehadiran</th>
...
<script>
            ...
            if (cells.length && cells[0].textContent.trim() !== 'Data tidak ditemukan pada periode yang dipilih.') {
                rows += `
                    <tr>
                        ...
                        <td>${cells[7].querySelector('input')?.value || "Rp. 0"}</td>
    ...
    document.getElementById('exportPdfGuruBtn').addEventListener('click', () => {
        ...
        document.querySelectorAll('#rekapGuruTable tbody tr').forEach(tr => {
            ...
            if (cells.length && cells[0].textContent.trim() !== 'Data tidak ditemukan pada periode yang dipilih.') {
                ...
                rows.push([
                    ...
                    cells[1].textContent.trim(), // Jumlah Jam
                    cells[2].textContent.trim(), // Jam Mati
                    cells[3].textContent.trim(),
                    cells[4].textContent.trim(),
                    cells[5].textContent.trim(),
                    cells[6].textContent.trim(),
                    cells[7].querySelector('input')?.value || "0", // Tunjab
                    cells[8].textContent.trim(), // Total
                    ""
                ]);
            }
        });
        ...
        doc.autoTable({
            head: [[
                'Nama Guru','Jumlah Kehadiran','Jam Mati','Apel Pagi',
