<!-- TABEL -->
{{-- <div class="hidden p-4 bg-white rounded shadow md:block">
...
<div class="p-4 bg-white rounded shadow">
    <div class="flex items-start justify-center mb-8">
        <h2 class="text-2xl font-extrabold">Daftar Jadwal Guru Mengajar</h2>
        <div class="flex gap-2">
            {{-- <button id="exportPDF" type="button" class="flex items-center px-3 py-2 text-white transition bg-red-700 rounded-lg hover:bg-red-800">
