                ...
                <div class="grid gap-8 p-0 border-none rounded-md shadow-none md:p-4 md:border md:shadow md:grid-cols-3">
                    ...
                    <div class="space-y-2">
                        <div class="grid md:grid-cols-[90px_10px_1fr] grid-cols-[120px_10px_1fr] items-center">
                            ...
                            <span class="text-left">:</span>
                            <a href="#" class="text-sky-600 hover:text-sky-800"><span>{{ $profil->email }}</span></a>
                        </div>
                        <div class="grid md:grid-cols-[90px_10px_1fr] grid-cols-[120px_10px_1fr] items-center">
                        ...
                        <div class="grid md:grid-cols-[90px_10px_1fr] grid-cols-[120px_10px_1fr] items-center">
                            ...
                            <span class="text-left">:</span>
                            <a href="#" class="underline text-sky-600 hover:text-sky-800"><span>{{ $profil->website }}</span></a>
                        </div>
                    </div>
                </div>
            </div>
