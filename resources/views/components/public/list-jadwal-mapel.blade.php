<div class="p-4 bg-white rounded shadow">
    ...
    <form method="GET" class="grid grid-cols-1 gap-2 mb-4 md:grid-cols-5">
        ...
        <div class="flex gap-2">
            <button type="submit" class="px-4 py-2 text-white bg-blue-600 rounded whitespace-nowrap hover:bg-blue-700" data-turbo="false">
                <i class="bi bi-funnel"></i> Filter
            </button>
            <a href="{{ route('public.jadwal_mapel.index') }}" class="px-4 py-2 text-white rounded whitespace-nowrap bg-slate-700 hover:bg-slate-800" data-turbo="false">
