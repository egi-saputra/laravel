@php
    ...
    $menus = [
            ...
            ['label' => 'Kelola Pengguna', 'route' => route('dev.users.index'), 'icon' => 'bi-people'],
            // ['label' => 'Kelola Data Tenants', 'route' => route('tenants.index'), 'icon' => 'bi-building'],
    ...
    $datas = [
        ['label' => 'Kelola Daftar GTK', 'route' => route('admin.guru.index'), 'icon' => 'bi-people'], // banyak orang / guru
        ...
        >
            ...
            <ul class="text-slate-500">
                @foreach ($datas as $data)
                    ...
                    @elseif(isset($data['type']) && $data['type'] === 'modal')
                        <li>
                            <button @click="open = true" class="w-full px-2 py-2 text-left rounded hover:bg-gray-100">
                                <i class="bi {{ $data['icon'] ?? 'bi-dot' }} me-2"></i>{{ $data['label'] }}
                            </button>
