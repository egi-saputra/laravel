@php
    ...
    $menus = [
            ['label' => 'Edit Profil', 'type' => 'modal'],
            ['label' => 'Dashboard', 'route' => route('user.dashboard')],
            ['label' => 'Riwayat Kegiatan', 'route' => route('user.kegiatan')],
        ];
    $accounts = [
            // ['label' => 'Edit Profil', 'route' => route('profile.edit'), 'icon' => 'bi-person'],
...
<div x-data="{ open: false, showMenu: false }">
    ...
    <!-- SIDEBAR -->
    <div class="z-30 w-full mt-3 bg-white border-r rounded shadow-md md:w-64 sm:pb-5">
