        ...
        <div class="hidden p-0 space-y-2 overflow-x-auto md:block md:flex-1 md:my-2">
            ...
            <div>
                ...
                <div class="grid grid-cols-3 gap-4 p-0 text-center md:rounded-xl md:mb-4 md:grid-cols-6">
                    ...
                    <!-- Menu 2 -->
                    {{-- <a href="{{ route('public.daftar_materi.index') }}" class="flex flex-col items-center justify-center p-4 transition-all shadow backdrop-blur bg-gray-50 rounded-xl hover:bg-sky-50 hover:shadow-md">
