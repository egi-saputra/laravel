...
<x-app-layout>
                            ...
                            @foreach($presensi as $p)
                                ...
                                <div class="p-5 transition duration-200 bg-white border shadow-sm rounded-xl hover:shadow-md">
                                    ...
                                    {{-- <p class="text-sm text-gray-600">
                                        <i class="text-blue-600 bi bi-person-badge"></i>
                                        Petugas: <strong>{{ $p->user->name ?? '-' }}</strong>
                                    </p> --}}
                                    {{-- Kelas --}}
                                    <p class="text-sm text-gray-600">
    ...
    <script>
        document.addEventListener("turbo:load", () => {
            const printBtn = document.getElementById('printAbsensi');
            if (!printBtn) return;
