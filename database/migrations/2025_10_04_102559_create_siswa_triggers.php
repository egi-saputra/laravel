...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::unprepared('
            DROP TRIGGER IF EXISTS after_insert_siswa_kelas;
        ...
        DB::unprepared('
            DROP TRIGGER IF EXISTS after_insert_siswa_kejuruan;
        ...
        // Trigger delete untuk data_kelas (aman dari negatif)
        DB::unprepared('
            DROP TRIGGER IF EXISTS after_delete_siswa_kelas;
        ...
        // Trigger delete untuk program_kejuruan (aman dari negatif)
        DB::unprepared('
            DROP TRIGGER IF EXISTS after_delete_siswa_kejuruan;
        ...
        DB::unprepared('
            DROP TRIGGER IF EXISTS after_update_siswa_kelas;
        ...
        DB::unprepared('
            DROP TRIGGER IF EXISTS after_update_siswa_kelas_add;
        ...
        DB::unprepared('
            DROP TRIGGER IF EXISTS after_update_siswa_kejuruan;
        ...
        DB::unprepared('
            DROP TRIGGER IF EXISTS after_update_siswa_kejuruan_add;
