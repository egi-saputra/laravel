...
class UserDataController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('dev.users.index', ['allUsers' => $allUsers]);
    }
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'role' => ['required','in:user,siswa,guru,staff,admin,developer'],
        ]);
    ...
    public function destroy($id)
    {
        ...
        if ($user->role === 'developer' && $user->id == 1) {
            return back()->with('alert', [
                'message' => 'Developer tidak dapat dihapus!',
                'type' => 'success',
                'title' => 'Berhasil'
            ]);
        }
        ...
        return redirect()->route('dev.users.index')->with('alert', [
